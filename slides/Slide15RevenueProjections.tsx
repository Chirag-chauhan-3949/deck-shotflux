    ...
    <div className="px-4 sm:px-8 md:px-12 py-4 sm:py-6">
        ...
        <table className="w-full text-xs sm:text-sm min-w-[700px]">
          ...
          <tbody>
            <tr className="border-t border-gray-700">
              ...
              <td className="p-2 sm:p-3 text-center text-gray-300">₹1,500</td>
              <td className="p-2 sm:p-3 text-center text-blue-400">₹30L</td>
              <td className="p-2 sm:p-3 text-center text-gray-300">₹160L</td>
              <td className="p-2 sm:p-3 text-center text-red-400">-₹130L</td>
            </tr>
            ...
            <tr className="border-t-2 border-green-500 bg-green-900/20">
              ...
              <td className="p-2 sm:p-3 text-center text-green-400 font-bold">+₹130L</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="bg-gray-800 p-4 sm:p-5 rounded-lg text-center">
          ...
          <p className="text-2xl sm:text-3xl font-bold text-white">₹530L</p>
        ...
        <div className="bg-gray-800 p-4 sm:p-5 rounded-lg text-center">
          ...
          <p className="text-2xl sm:text-3xl font-bold text-white">₹130L</p>
