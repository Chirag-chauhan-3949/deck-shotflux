...
const Slide1Title = () => {
  return (
    <div className="flex flex-col items-center justify-center text-center px-4 sm:px-8">
      ...
      <p className="text-2xl sm:text-3xl text-gray-300 mb-2 sm:mb-3">From Story to Film</p>
  ...
  From <span className="text-white font-semibold">script to film</span> in minutes — 
  using an <span className="text-indigo-400 font-medium">industry-standard workflow</span> 
  that saves <span className="text-white font-semibold">over 80% of time and costs</span> 
